...
class SnippetViewSet(viewsets.ModelViewSet):
    ...
    # used the @detail_route decorator to create a custom action
...
class SnippetList(generics.ListCreateAPIView):
    ...
    def perform_create(self, serializer):  #modify how the instance save is managed
        serializer.save(owner=self.request.user)
...
class SnippetListMixins(mixins.ListModelMixin, mixins.CreateModelMixin, generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        return self.create(request, *args, **kwargs) #provided by CreateModelMixin

# snippetdetail CBV using mixins
...
#old snippetlist CBV, manual function definitions
...
#old snippetdetail CBV, manual function definitions
